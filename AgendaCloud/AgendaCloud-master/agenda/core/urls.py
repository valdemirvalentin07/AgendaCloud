...
urlpatterns = [
    ...
    path('contatos/relatorio/', views.relatorio_pdf, name='relatorio_pdf'),
    path('contatos/editar/<str:id>/', views.editar_contato, name='editar_contato'),
    path('contatos/excluir/<str:id>/', views.excluir_contato, name='excluir_contato'),
